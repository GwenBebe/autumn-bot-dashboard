            ...
            <section className="commands" id="section-wipes">
                ...
                <section className="card-large">
                    <section className="flex-items">
                        ...
                        <article className="command">
                            <h1>user-info</h1>
                            <p>Get stats on a specified user</p>
                            <div className="mono">-user-info {'{'}user{'}'}</div>
                        </article>
                        <article className="command">
                            <h1>prefix</h1>
                            <p>Change the prefix for the bot on your server</p>
                            <div className="mono">-prefix {'{'}prefix{'}'}</div>
                        </article>
                    </section>
                </section>
                <div className="commands-class-head">
